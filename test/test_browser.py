...
GET_PAD_RESPONSE = {
    "PadConfigResponse": {'resultCode': 200, 'data': {'errors': '', 'data': {'origin_failure_redirect_url': '',
                                                                             ...
                                                                             'deploy_status': 'New',
                                                                             'buffer_secs': -1}}}}
PAD_NOT_FOUND_RESPONSE = {'PadConfigResponse':
                              {'resultCode': 400, 'data': {'errors': 'Invalid PAD supplied.', 'data': {}}}}
