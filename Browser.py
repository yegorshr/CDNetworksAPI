...
class Browser(object):
    ...
    def GetTokenForSelectedControlGroup(self, AutonticationToken):
        ...
        """
        Dict = SelectedFromList(AutonticationToken["loginResponse"]["session"], self.args.svcGroupName,
    ...
    def SelectPAD(self, PADsList):
        Dict = SelectedFromList(PADsList["PadConfigResponse"]["data"]["data"], self.args.srcPADName,
